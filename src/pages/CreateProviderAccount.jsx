...
export default function CreateProviderAccount() {
    ...
    return (
        ...
        ```
      */}
                <div className="flex min-h-full flex-col justify-center py-12 px-6 lg:px-8 md:mt-12">
                    <div className='shadow-xl mx-auto '>
                        <div className="sm:mx-auto sm:w-full sm:max-w-md">
                            <img
                                ...
                                alt="Your Company"
                            />
                            <h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Create your Provider Account</h2>
                        </div>
                            ...
                            <div className="bg-white py-8 px-4  sm:rounded-lg sm:px-10">
                                <form className="space-y-6" action="#" method="POST">
                                    <div>
                                        ...
                                        <p className='text-xs ml-2 text-gray-500'>We will call or text to confirm your number. Standard message and data rates apply</p>
                                    </div>
